# References:
# HiT: https://github.com/xiachangxue/DeepHyperX/blob/main/vit_pytorch/hit.py
...
class HiT(nn.Module):
    ...
    def __init__(self, layers=[4, 3, 14, 3], img_size=15, patch_size=3, in_chans=3, num_classes=1000,
                 embed_dims=[480, 480, 512, 512], transitions=[False, True, False, False], segment_dim=[8, 8, 4, 4], mlp_ratios=[3, 3, 3, 3], skip_lam=1.0,
