# References:
# SpectralFormer: https://github.com/danfenghong/IEEE_TGRS_SpectralFormer/blob/main/vit_pytorch.py
...
class GSE_Embedding(nn.Module):
    def __init__(self, in_dim, out_dim, n_bands):
        super().__init__()
        self.embed = nn.Conv1d(in_dim, out_dim, kernel_size=n_bands, padding=n_bands // 2, stride=1)
